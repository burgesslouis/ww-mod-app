...
export const DARKEST_NIGHT_ROLES: RoleDefinition[] = [
  ...
  role(D.hag, 'Hag', FACTION.anyShadow, ['Any Shadow', 'Mystic'], [TRAIT.shadow, TRAIT.corrupt, TRAIT.mystic, TRAIT.anyShadowWinner], 'Hexes Mystics who choose it.', 'All Shadow roles locate the Hag on the first night. A Mystic who targets the Hag receives negative information and cannot protect while the Hag lives.', [
...
export const OFFICIAL_SCENARIO: ScenarioDefinition = withChecksum({
  ...
  setupPipeline: [
    { id: 'official.setup.actions', type: 'role-actions', label: 'First night', trigger: 'setup.action', abilityIds: setupIds },
